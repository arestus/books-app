...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data source=KANINI-LTP-456\\SQLSERVER2021CV;Integrated Security=true;Initial Catalog=pubs");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.EmpId)
                    .HasName("PK__employee__AFB3EC0D65CAA45A");
                ...
                entity.Property(e => e.Totalsalery).HasColumnName("totalsalery");

                entity.HasOne(d => d.Sal)
                    .WithMany(p => p.Employeesalaries)
                    .HasForeignKey(d => d.SalId)
                    .HasConstraintName("FK__employees__salId__46B27FE2");
            });
            ...
            modelBuilder.Entity<Salary>(entity =>
            {
                entity.HasKey(e => e.SalId)
                    .HasName("PK__salary__E3E8929641858653");
